...
public class java_mongo implements ActionListener {
    ...
    public java_mongo() {
        try {
            ...
            String connectionString = "mongodb+srv://" + encodedUsername + ":" + encodedPassword + "@cluster0.tmmyi8b.mongodb.net/";
...
class Quiz_JFrame implements ActionListener{
    ...
    Quiz_JFrame(String name) {
        ...
        String[] questionTexts = {"Which keyword is used to declare an interface in Java?",
        ...
        "Which keyword is used to implement an interface in a class in Java?"

                
        };
        String[][] options = {
            {"interface", "class", "implements", "interface class"},
            {"To provide a contract for implementing classes", "To define concrete methods", "To restrict access to methods", "To hide data"},
            {"Interfaces can have fields with values that can be changed", "Interfaces can extend multiple classes", "Interfaces can have private methods", "Interfaces can have constructors"},
            {"Yes", "No", "Sometimes", "Only if the interface has default methods"},
            {"extends", "implements", "inherits", "extends and implements"}
    ...
    public void actionPerformed(ActionEvent e) {
        int totalMarks = 0;
        // Correct answers for each questions
        String[] correctAnswers = 
                { "interface", "To provide a contract for implementing classes", "Interfaces can have private methods", "No", "implements"
                 };
